...
<div class="pinfo-w">
    ...
    <div class="pinfo-box">
    	<div class="pinfo-main">
        	<div class="pinfo-m-title">基本資訊</div>
            <div class="pinfo-m-info">
                ...
                <div class="pinfo-m-row">
            		<span>聯絡地址* </span>
                    <input name="zip" type="text" id="zip" placeholder="" class="input-postal" />
    ...
    <div class="commo-w">
		<div class="page-box">
        	<div class="prev-btn"><a href="personal.aspx">取消加入</a></div>
         	<div class="next-btn" id="btnUpdate"><a href="javascript:">確認加入</a></div>
		</div>
	</div>
